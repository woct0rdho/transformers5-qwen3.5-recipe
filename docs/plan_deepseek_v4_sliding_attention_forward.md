...
1. contiguous BF16 BSHD output;
2. FP32 LSE `[B,64,2048]`;
3. one raw FP16 scaled-score band `[B,64,2048,128]`.
...
/tmp/deepseek_v4_sliding_probability_normalize_tuning.json
/tmp/deepseek_v4_training_sliding_specialized_report.json
```
